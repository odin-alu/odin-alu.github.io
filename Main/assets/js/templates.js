		...
		<section class="weather-sunrise">
			<div class="grd-row">
				...
				<div class="grd-row-col-3-6 txt--right py2">
					<img onclick="templateSettings()" class="wa-icon clickable" src="Main\assets\img\feather-settings.svg"/>
				</div>
			</div>
		</section>
	`;
		...
		<div class="container">
			...
			<section class="weather-settings-header">
				<div class="grd-row">
				  	...
				  	<div class="grd-row-col-3-6 txt--right py2">
				  		<img onclick="templateDash()" class="wa-icon clickable" src="Main\assets\css\img\feather-x.svg"/>
				  	</div>
				</div>
			</section>
